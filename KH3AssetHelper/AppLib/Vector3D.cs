...
namespace APPLIB
{
  public class Vector3D
  {
    ...
    public float DotProduct(Vector3D Vec) => (float) ((double) this.X * (double) Vec.X + (double) this.Y * (double) Vec.Y + (double) this.Z * (double) Vec.Z);
    ...
    public bool IsEqualTo(Vector3D Vec) => (double) this.X == (double) Vec.X && (double) this.Y == (double) Vec.Y && (double) this.Z == (double) Vec.Z;
    ...
    public bool IsPerpendicularTo(Vector3D Vec) => (double) this.AngleTo(Vec) == Math.PI / 2.0;

    public object IsXAxis() => (double) this.X != 0.0 && (double) this.Y == 0.0 && (double) this.Z == 0.0 ? (object) true : (object) false;

    public object IsYAxis() => (double) this.X == 0.0 && (double) this.Y != 0.0 && (double) this.Z == 0.0 ? (object) true : (object) false;

    public object IsZAxis() => (double) this.X == 0.0 && (double) this.Y == 0.0 && (double) this.Z != 0.0 ? (object) true : (object) false;
    ...
    public Vector3D Add(Vector3D Vec) => new Vector3D()
    {
      X = this.X + Vec.X,
      Y = this.Y + Vec.Y,
      Z = this.Z + Vec.Z
    ...
    public Vector3D Subtract(Vector3D Vec) => new Vector3D()
    {
      X = this.X - Vec.X,
      Y = this.Y - Vec.Y,
      Z = this.Z - Vec.Z
    ...
    public static bool operator ==(Vector3D a, Vector3D b) => (double) a.X == (double) b.X && (double) a.Y == (double) b.Y && (double) a.Z == (double) b.Z;

    public static bool operator !=(Vector3D a, Vector3D b) => (double) a.X != (double) b.X || (double) a.Y != (double) b.Y || (double) a.Z != (double) b.Z;

    public static Vector3D operator +(Vector3D a, Vector3D b) => new Vector3D(a.X + b.X, a.Y + b.Y, a.Z + b.Z);

    public static Vector3D operator -(Vector3D left, Vector3D right) => new Vector3D()
    {
      X = left.X - right.X,
      Y = left.Y - right.Y,
      Z = left.Z - right.Z
    ...
    public static Vector3D Multiply(Vector3D vector, float scale) => new Vector3D(vector.X * scale, vector.Y * scale, vector.Z * scale);

    public static Vector3D Multiply(Vector3D vector, int scale) => new Vector3D(vector.X * (float) scale, vector.Y * (float) scale, vector.Z * (float) scale);

    public static Vector3D Multiply(Vector3D vector, Vector3D scale) => new Vector3D(vector.X * scale.X, vector.Y * scale.Y, vector.Z * scale.Z);
    ...
    public static Vector3D operator *(Vector3D left, float right) => Vector3D.Multiply(left, right);

    public static Vector3D operator *(Vector3D left, int right) => Vector3D.Multiply(left, right);

    public static Vector3D operator *(float left, Vector3D right) => Vector3D.Multiply(right, left);

    public static Vector3D operator *(Vector3D left, Vector3D right) => Vector3D.Multiply(left, right);

    public static Vector3D operator *(Vector3D left, Quaternion3D right) => Vector3D.Multiply(left, right);
    ...
    public static Vector3D Cross(Vector3D left, Vector3D right) => new Vector3D((float) ((double) left.Y * (double) right.Z - (double) left.Z * (double) right.Y), (float) ((double) left.Z * (double) right.X - (double) left.X * (double) right.Z), (float) ((double) left.X * (double) right.Y - (double) left.Y * (double) right.X));

    public static float Dot(Vector3D left, Vector3D right) => (float) ((double) left.X * (double) right.X + (double) left.Y * (double) right.Y + (double) left.Z * (double) right.Z);
    ...
    public string WriteString() => string.Format("{0} {1} {2}", (object) this.X, (object) this.Y, (object) this.Z);
  }
}
